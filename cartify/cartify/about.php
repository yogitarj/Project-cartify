...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p>Hey There ! We are a team of developers and our team consists of  Yogita Rajendra Jondhale,Anandkumar Bhosale, & Vishal Pangare . We are pursuing Student of Bachelors of Computer Application from SSP College . we love designing websites and exploring new things. Learning new things is our hobby.</p>

         <p>We would like to thank Ganesh Sir  for guiding us through the session and making us able to develop projects like this. </p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <p>Cartify is great if you choose good sellers . A variety of required item available . Customers can return and refund full amount within 7 days easily . Cartify is boosting eCommerce business in Pune.It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Using Cartify for online shopping from almost 3 years. Outstanding experience with them. Game vouchers and pick up point as delivery with 0 shipping charges are super saving services.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Cartify is cool! I have ordered hundreds of products from it and never got any scam. It delivers products in time with out delay. Packaging of products are strong and delivery rates are too low. Just amazing Website will keep shopping from Cartify.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
